...
export default function FeaturedItems({ isReversed = false }) {


    return (
        <div className="container mx-auto max-w-screen-xl my-10">
            <div className="grid grid-cols-3 gap-x-2">
                <div className={isReversed ? "order-last" : ""}>
                    <img src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fgraphicgoogle.com%2Fwp-content%2Fuploads%2F2017%2F01%2Fgeometric-graphic-design-5.jpg&f=1&nofb=1" className="object-fill h-96" />
                    <div className="flex flex-col gap-y-4 py-12 items-center justify-between px-6">
                        <h3 className="text-2xl text-center font-bold">Category 1</h3>
                        <a className="text-indigo-600 hover:text-indigo-800 hover:underline cursor-pointer">See More</a>
                    </div>
                </div>

                <div className="col-span-2 grid grid-cols-2 gap-x-2 gap-y-4">
                    ...
                    <div className="max-w-sm bg-white rounded-lg shadow-md hover:shadow-xl hover:shadow-blue-100 dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <div className="px-2 py-3">
                            <a href="#">
                                <h3 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Apple Watch Series 7 GPS</h3>
                            </a>
                            <div className="flex justify-between items-center py-2">
                                <div className="flex items-center">
                                    <svg className="w-5 h-5 text-yellow-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
