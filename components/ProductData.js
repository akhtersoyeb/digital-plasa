...
export default function ProductData() {
  return (
    <section className="text-gray-600 body-font container max-w-7xl mx-auto px-2">
      
      <div className="flex flex-wrap my-6 text-center">
        <div className="pr-2 py-3 md:py-0 md:w-1/4 sm:w-1/2 w-full">
        ...
        <div className="px-2 py-3 md:py-0 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
        ...
        <div className="pl-2 py-3 md:py-0 md:w-1/4 sm:w-1/2 w-full">
          <div className="border-2 border-gray-200 px-4 py-6 rounded-lg">
            <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="text-indigo-500 w-12 h-12 mb-3 inline-block" viewBox="0 0 24 24">
