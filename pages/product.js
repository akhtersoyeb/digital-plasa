  ...
  return (
    <>
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container max-w-7xl px-2 py-10 mx-auto">
          <div className="flex flex-col items-center lg:flex-row">
            {/* <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="https://dummyimage.com/400x400" /> */}
            <Carousel />
            <div className="lg:pl-10 lg:flex-1">
      ...
      {/* Similar Items */}
      <ProductCollection title="Similar Items" products={products} />
      {/* End of Similar Items */}

      {/* Reviews */}
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-2 max-w-7xl py-6 mx-auto">
