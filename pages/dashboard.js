    ...
    return (
        <>
            ...
            <section className="text-gray-600 body-font">
                <div className="container max-w-7xl px-2 py-12 mx-auto">

                    <div className="flex flex-wrap text-center">
                        <div className="md:w-1/4 sm:w-1/2 w-full py-2 px-1">
            ...
            <div className="container max-w-7xl mx-auto px-2 mt-10 mb-24 flex flex-col">
